...
public class PostController {
	...
	public ResponseEntity<PostDto> findPostByPostId(@PathVariable int postId)
	{
	...
	public ResponseEntity<ApiResponse> deletePost(@PathVariable Integer postId)
	{
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("Post is Deleted Sesccessfully", true),HttpStatus.OK);
	}
	...
	{
		InputStream resource1 =this.fileService.getResource(path,imageName);
